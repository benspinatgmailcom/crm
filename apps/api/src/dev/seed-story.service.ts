...
export class SeedStoryService {
  ...
  private async seedApexActivities(
    ...
    const activities: Array<{ type: string; payload: Record<string, unknown>; daysAgo: number }> = [
      ...
      { type: 'task', payload: { title: 'Send revised pricing', status: 'done', dueAt: daysAgo(70).toISOString(), priority: 'medium' }, daysAgo: 70 },
      ...
      { type: 'task', payload: { title: 'Follow up on DR add-on', status: 'open', dueAt: daysAgo(5).toISOString(), priority: 'high' }, daysAgo: 45 },
      ...
      { type: 'task', payload: { title: 'Get legal sign-off', status: 'done', dueAt: daysAgo(25).toISOString(), priority: 'medium' }, daysAgo: 25 },
      ...
      { type: 'task', payload: { title: 'Countersign and file', status: 'open', dueAt: daysAgo(3).toISOString(), priority: 'high' }, daysAgo: 5 },
    ];
  ...
  private async seedNorthwindActivities(
    ...
    const activities: Array<{ type: string; payload: Record<string, unknown>; daysAgo: number }> = [
      ...
      { type: 'task', payload: { title: 'Draft proposal', status: 'done', dueAt: daysAgo(45).toISOString(), priority: 'medium' }, daysAgo: 45 },
      ...
      { type: 'task', payload: { title: 'Send fiber topology', status: 'done', dueAt: daysAgo(18).toISOString(), priority: 'low' }, daysAgo: 18 },
  ...
  private async seedGlobexActivities(
    ...
    const activities: Array<{ type: string; payload: Record<string, unknown>; daysAgo: number }> = [
      ...
      { type: 'task', payload: { title: 'Send proposal', status: 'done', dueAt: daysAgo(90).toISOString(), priority: 'medium' }, daysAgo: 90 },
      ...
      { type: 'task', payload: { title: 'Follow up with Frank', status: 'open', dueAt: daysAgo(40).toISOString(), priority: 'medium' }, daysAgo: 55 },
      ...
      { type: 'task', payload: { title: 'Re-engage Globex', status: 'open', dueAt: daysAgo(5).toISOString(), priority: 'high' }, daysAgo: 20 },
    ];
